...
public class Menu {
    public static void menu(){
        ...
        phonebook.Phonebook phones = new phonebook.Phonebook();
        phonebook.ExportToCSV exportToCSV = new phonebook.ExportToCSV();
        phonebook.ImportFromCSV importFromCSV = new phonebook.ImportFromCSV();
        ...
        phonebook.LoggerClass.logger.log(Level.INFO, "Stop menu");
    }
